        ...
        <div style="max-width: 1024px; margin: 0 auto;">
            ...
            <div id="page-header"
                ...
                <div style="display: flex; align-items: center; gap: 1rem;">
                    ...
                    <div>
                        <h1 style="font-size: 2rem; font-weight: 700; color: #1f2937; margin: 0;">Edit User</h1>
                        <p style="color: #6b7280; margin: 0; font-weight: 500;">Updating profile for: <span
                                style="color: #1f2937;">{{ $user->name }}</span></p>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('admin.users.update', $user) }}" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <input type="checkbox" id="api_authorized" name="api_authorized" value="1"
                                    {{ old('api_authorized', $user->api_authorized) ? 'checked' : '' }}
                    ...
                    <div style="margin-top: 1.75rem;">
                        ...
                        @if ($user->company_logo)
                            <div
                                style="margin-bottom: 1rem; display: flex; align-items: center; gap: 1rem; background: #f9fafb; padding: 0.75rem; border-radius: 0.75rem; border: 1px solid #e5e7eb;">
                                <img src="{{ Storage::url($user->company_logo) }}" alt="Current Logo"
                                ...
                                <div>
                                    ...
                                    <p style="margin: 0; font-size: 0.875rem; color: #6b7280;">Upload a new file below to
                                        replace it.</p>
                                </div>
                            </div>
                        @endif
                        ...
                        <div
                            ...
                            <p style="font-size: 0.75rem; color: #6b7280; margin-top: 0.5rem;">PNG, JPG, GIF up to 2MB.
                                Leave empty to keep current logo.</p>
                            @error('company_logo')
                                <span style="{{ $errorTextStyle }}">{{ $message }}</span>
                            @enderror
                        </div>
