    ...
    <div class="auth-container">
        <div class="auth-card">
            ...
            <div class="actions-container">
                <form method="POST" action="{{ route('verification.send') }}" id="resend-form" style="width: 100%;">
                    @csrf
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (resendForm) {
                resendForm.addEventListener('submit', function() {
                    ...
                    // Hide text by making it transparent to keep button size
                    resendBtn.style.color = 'transparent';
                });
            }
        });
    </script>
