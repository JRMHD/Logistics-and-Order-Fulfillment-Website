                ...
                <div class="cs-logi-header-middle">
                    <div class="cs_nav cs_medium">
                        <ul class="cs_nav_list">
                            ...
                            <li>
                                <a href="{{ url('/services') }}" class="cs-text_b_line"><span>Services</span></a>
                            </li>
                            <li>
                                <a href="{{ url('/order-tracking') }}" class="cs-text_b_line"><span>Shipment
                                        Tracking</span></a>
                            </li>
                            <li>
                                <a href="{{ url('/contact') }}" class="cs-text_b_line"><span>Contact</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
