        ...
        <div class="container" style="max-width: 1200px; margin: 0 auto;">
            ...
            <div style="text-align: center; margin-bottom: 60px;">
                <span
                    ...
                    Services</span>
                <h2 style="font-size: 42px; color: #1a1a1a; margin: 0 0 30px 0;">MEDICAL COURIER</h2>
            </div>
            ...
            <div
                ...
                <p style="color: #444; line-height: 1.8; font-size: 16px;">
                    In the healthcare industry, timely and secure delivery of medical supplies, specimens, and equipment
                    can be a matter of life and death. We understand the critical nature of these deliveries, which is
                    why we offer <strong>specialized medical courier services</strong> designed to meet the unique needs
                    of healthcare providers. Whether you're transporting lab samples, pharmaceuticals, or medical
                    equipment, we ensure your items are handled with the utmost care and delivered on time, every time.
                </p>
            </div>

            <!-- Core Principles -->
            <div style="margin-bottom: 50px;">
                <h3 style="color: #1a1a1a; font-size: 28px; margin-bottom: 30px; text-align: center;">Our Medical
                    Courier Services are built on three core principles:<br><span style="color: #D40511;">Security,
                        Speed, and Compliance</span></h3>
                ...
                <div style="display: grid; gap: 25px;">
                    ...
                    <div
                        ...
                        <h4 style="color: #1a1a1a; font-size: 20px; margin-bottom: 15px;">✅ Secure Handling</h4>
                        <p style="color: #666; line-height: 1.7;">Medical items often require specialized packaging and
                            handling to maintain their integrity. Our team is trained to handle sensitive medical goods,
                            including lab specimens, blood samples, vaccines, and pharmaceuticals, with the highest
                            level of care.</p>
                    </div>
                    ...
                    <div
                        style="background: #fff; border-left: 4px solid #D40511; padding: 30px; box-shadow: 0 2px 15px rgba(0,0,0,0.05);">
                        <h4 style="color: #1a1a1a; font-size: 20px; margin-bottom: 15px;">✅ Timely Deliveries</h4>
                        <p style="color: #666; line-height: 1.7;">In healthcare, every second counts. Our medical
                            courier services are designed for speed, ensuring fast and reliable delivery to hospitals,
                    ...
                    <div
                        style="background: #fff; border-left: 4px solid #D40511; padding: 30px; box-shadow: 0 2px 15px rgba(0,0,0,0.05);">
                        <h4 style="color: #1a1a1a; font-size: 20px; margin-bottom: 15px;">✅ Compliance</h4>
                        <p style="color: #666; line-height: 1.7;">The transport of medical goods is subject to strict
                            regulatory requirements. We adhere to all local and international regulations, including
                            guidelines for the handling and transportation of hazardous materials.</p>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
                    ...
                    <div style="padding: 20px; background: #fff; border-radius: 10px;">
                        ...
                        <p style="color: #666; line-height: 1.6;">We understand the importance of timely deliveries in
                            the healthcare sector.</p>
                    </div>

                    <div style="padding: 20px; background: #fff; border-radius: 10px;">
                        <h5 style="color: #D40511; font-size: 18px; margin-bottom: 10px;">• Security</h5>
                        <p style="color: #666; line-height: 1.6;">Our specialized packaging and handling processes
                            ensure protection.</p>
                    </div>

                    <div style="padding: 20px; background: #fff; border-radius: 10px;">
                        <h5 style="color: #D40511; font-size: 18px; margin-bottom: 10px;">• Compliance</h5>
                        <p style="color: #666; line-height: 1.6;">We adhere to all regulatory requirements for safe and
                            legal delivery.</p>
                    </div>

                    <div style="padding: 20px; background: #fff; border-radius: 10px;">
                        <h5 style="color: #D40511; font-size: 18px; margin-bottom: 10px;">• Real-Time Tracking</h5>
                        <p style="color: #666; line-height: 1.6;">Stay informed with our advanced tracking system.</p>
                    </div>

                    <div style="padding: 20px; background: #fff; border-radius: 10px;">
                        <h5 style="color: #D40511; font-size: 18px; margin-bottom: 10px;">• Customer-Centric Approach
                        </h5>
                        <p style="color: #666; line-height: 1.6;">We work closely with healthcare providers for
                            tailored
                            solutions.</p>
                    </div>
                </div>
